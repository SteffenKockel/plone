...
def setup_product():
    ...
    import groovecubes.webmail
    zcml.load_config('configure.zcml', groovecubes.webmail)
    ...
    ztc.installPackage('groovecubes.webmail')
...
setup_product()
ptc.setupPloneSite(products=['groovecubes.webmail'])
